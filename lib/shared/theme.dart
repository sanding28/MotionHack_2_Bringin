...
Color kTransparant = Colors.transparent;
...
Color keyStrokeCOlor = Color(0xffF1F1F1);
Color keyGrey2Color = Color(0xffAAAAAA);
...
TextStyle grey2TextStyle = GoogleFonts.montserrat(
  color: keyGrey2Color,
);
